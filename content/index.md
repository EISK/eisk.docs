...
<div class="hero">
  <div class="wrap">
    ...
    <div class="buttons-unit">
      <a href="docs/webapi/get-started/index.html" class="button"><i class="glyphicon glyphicon-send"></i>Get Started</a>
    </div>
  </div>
</div>
    ...
    <div class="row">
      <div class="col-md-10 col-md-offset-1">
        ...
        <section>
          ...
          <div class="lead"><a href="docs/webapi/get-started/what-is-eisk.html">What is EISK?</a></div>
        </section>
      </div>
    </div>
  </div>
  ...
  <div class="container">
    <div class="row">
      <div class="buttons-unit" style="padding-bottom:50px">
        <a href="docs/webapi/get-started" class="btn btn-primary" style="font-size:2em;display:inline;padding:15px"><i class="glyphicon glyphicon-send" style="font-size:1em;padding:0 20px 0 0"></i>Get Started</a>
      </div>
    </div>
  </div>
</div>
